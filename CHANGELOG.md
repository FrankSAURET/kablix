...
- **La mesure de l'analyseur logique ne vit plus dans le fichier du projet.** Elle s'écrit au fur et à mesure dans un fichier de session, un par projet ouvert, effacé quand le projet se ferme. Le `.projix` ne s'alourdit plus de dizaines de milliers de fronts, et la mesure ne peut plus être perdue faute d'avoir été enregistrée au bon moment. Les réglages de l'instrument, eux, restent dans le projet.
