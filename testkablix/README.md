...
| DMX512 : carte Grove + projecteur PAR 38 | `dmx-uno` | `dmx-pico` | les deux composants de la bibliothèque publique (`.kompix`) ; le projecteur prend rouge, vert puis bleu — liaison simulée (broche, adresse, canaux) et continuité du câblage UART → XLR contrôlées |
