# Test des QUATRE circuits integres logiques OU EXCLUSIF et NON-ET : chaque
...
BOITIERS = [
    ("CD4070  OU EXCLUSIF", 4, "ouex"),
    ("74HC86  OU EXCLUSIF", 5, "ouex"),
    ("CD4011  NON-ET     ", 6, "nonet"),
    ("74HC00  NON-ET     ", 7, "nonet"),
]
