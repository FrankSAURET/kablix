...
// « Capteur de lumière » (ex-photorésistance) : double sortie AO+DO, curseur
// d'intensité lumineuse en simulation (base AnalogDigitalSensorElement).
export class PhotoresistorSensorElement extends AnalogDigitalSensorElement {
