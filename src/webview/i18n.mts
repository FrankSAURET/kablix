...
const FR: Record<string, string> = {
  ...
  'Power rating (W)': 'Puissance admissible (W)',
  'Film (¼ W)': 'Couche (¼ W)',
  'Power, finned aluminium': 'Puissance, aluminium à ailettes',
  'Power, ceramic': 'Puissance, céramique',
  ...
  '{0} label(s) selected': '{0} étiquette(s) sélectionnée(s)',
  'Delete these labels': 'Supprimer ces étiquettes',
