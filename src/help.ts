...
Schéma de la réponse :
{
  ...
  "pinRoles": { "AO": "SORTIE" }
    ...
    <ol class="steps">
      ...
      <li><strong>Librairies (modules <code>.py</code>)</strong> : vos modules perso sont copiés automatiquement sur le Pico simulé au lancement — placez-les <strong>à côté du script</strong> (même dossier) ou dans un sous-dossier <code>lib/</code> (ajouté à <code>sys.path</code>, comme sur une vraie carte). <code>import ma_lib</code> fonctionne alors sans configuration.</li>
