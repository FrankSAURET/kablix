...
- **CHANGELOG rempli au fil de l'eau** (règle globale, 12/09/2026) : les entrées du lot vont sous le numéro de la PROCHAINE publication, avec `prochaine publication` à la place de la date — ici `## 2026.9.5 (prochaine publication)`. « On prépare la publication » = ce numéro est gardé et la date du jour remplace la mention. Toujours en **français**, côté utilisateur, en trois parties (Nouveauté / Modification / Correction).
