# 74xx08 — quadruple porte ET à 2 entrées

![74xx08](../../img/composants/74xx08.webp)

Boîtier DIL-14 à enficher sur la platine d'essai : **quatre portes ET indépendantes**, chacune avec ses deux entrées et sa sortie. Une porte ET sort 1 **seulement si ses deux entrées valent 1**.
...
seules HC, AC, ACT et C y fonctionnent — un 74LS08 sur une Pico ne fait rien.
...
|---|---|---|
| `ref` | Référence du boîtier — en changer change le brochage, pas le dessin | 74xx08 |
...
- Le ET, c'est « les deux à la fois » : une commande qui n'agit que si une autorisation est présente.
