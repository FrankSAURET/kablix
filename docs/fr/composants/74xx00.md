# 74xx00 — quadruple porte NON-ET à 2 entrées

![74xx00](../../img/composants/74xx00.webp)

Boîtier DIL-14 à enficher sur la platine d'essai : **quatre portes NON-ET indépendantes**, chacune avec ses deux entrées et sa sortie. Une porte NON-ET sort 0 **seulement si ses deux entrées valent 1** : c'est un ET suivi d'un inverseur.
...
seules HC, AC, ACT et C y fonctionnent — un 74LS00 sur une Pico ne fait rien.
...
| 4 | **A2** | entrée A de la porte 2 |
| 5 | **B2** | entrée B de la porte 2 |
| 6 | **Q2** | sortie de la porte 2 |
| 7 | **GND** | masse — **fil noir** |
| 8 | **Q3** | sortie de la porte 3 |
| 9 | **B3** | entrée B de la porte 3 |
| 10 | **A3** | entrée A de la porte 3 |
...
|---|---|---|
| `ref` | Référence du boîtier — en changer change le brochage, pas le dessin | 74xx00 |
...
- Une **entrée en l'air n'est pas un 0** : la sortie reste indéterminée tant que cette entrée compte (ici, une seule entrée à 0 suffit à décider).
...
- Le NON-ET est la porte **universelle** : toutes les autres fonctions se construisent avec lui. Ses deux entrées reliées ensemble en font un inverseur.
