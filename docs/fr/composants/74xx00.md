...
Une Uno sort 5 V : toutes les familles y passent. Une **Pico ne sort que 3,3 V** : seules HC, AC, ACT et C y fonctionnent — un 74LS00 sur une Pico ne fait rien.
...
- La NON-ET est la porte **universelle** : toutes les autres fonctions se construisent avec elle. Ses deux entrées reliées ensemble en font un inverseur.
