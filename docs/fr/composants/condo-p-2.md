...
Condensateur électrochimique aluminium, **polarisé**. Les fortes capacités du
lot : charge et décharge exponentielles, terminées à 5·R·C.
...
- Constante de temps longue : avec 10 kΩ, 100 µF donne τ = 1 s, soit 5 s pour
  la charge complète — bien visible dans le traceur de courbes.
