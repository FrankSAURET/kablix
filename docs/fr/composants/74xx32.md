# 74xx32 — quadruple porte OU à 2 entrées

![74xx32](../../img/composants/74xx32.webp)

Boîtier DIL-14 à enficher sur la platine d'essai : **quatre portes OU indépendantes**, chacune avec ses deux entrées et sa sortie. Une porte OU sort 1 **dès qu'une de ses entrées vaut 1**.
...
seules HC, AC, ACT et C y fonctionnent — un 74LS32 sur une Pico ne fait rien.
...
|---|---|---|
| `ref` | Référence du boîtier — en changer change le brochage, pas le dessin | 74xx32 |
...
- Le OU, c'est « l'un ou l'autre » : deux boutons qui commandent la même chose.
