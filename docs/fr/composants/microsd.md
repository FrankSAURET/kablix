...
MicroPython n'embarque pas de pilote de carte SD : posez le fichier `sdcard.py`
(bibliothèque officielle *micropython-lib*) dans un dossier `lib/` **à côté de
votre programme** — Kablix l'injecte automatiquement.
