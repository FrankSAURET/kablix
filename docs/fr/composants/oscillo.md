...
Le coin **bas droit** de l'écran rappelle les deux calibres, dans l'unité qui parle :

```
Vert : 2 V/div | Hor : 500 ms/div
```

## Ce que montre l'écran

- La courbe **défile vers la gauche** : le présent est au bord **droit**, le passé s'en va par la gauche. La largeur visible vaut **10 carreaux**, donc dix fois le calibre horizontal.
