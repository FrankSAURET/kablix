...
Ces inverseurs sont à **trigger de Schmitt** : sur un vrai circuit, leur seuil de basculement remonte à la montée et descend à la descente, ce qui nettoie un signal lent ou bruité. En simulation les niveaux sont francs, l'hystérésis ne se voit donc pas. Son jumeau de la série 74 est le [74xx14](74xx14.md).
