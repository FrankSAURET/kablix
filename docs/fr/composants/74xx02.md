...
Une Uno sort 5 V : toutes les familles y passent. Une **Pico ne sort que 3,3 V** : seules HC, AC, ACT et C y fonctionnent — un 74LS02 sur une Pico ne fait rien.
...
- Le NON-OU est universel : deux NON-OU croisés forment une bascule RS, la mémoire d'un bit.
