# 74xx86 — quadruple porte OU EXCLUSIF à 2 entrées

![74xx86](../../img/composants/74xx86.webp)

Boîtier DIL-14 à enficher sur la platine d'essai : **quatre portes OU EXCLUSIF indépendantes**, chacune avec ses deux entrées et sa sortie. Une porte OU EXCLUSIF sort 1 **quand ses deux entrées diffèrent**.
...
seules HC, AC, ACT et C y fonctionnent — un 74LS86 sur une Pico ne fait rien.
...
|---|---|---|
| `ref` | Référence du boîtier — en changer change le brochage, pas le dessin | 74xx86 |
...
- Le OU EXCLUSIF compare deux bits (égaux → 0, différents → 1) et sert de demi-additionneur.
