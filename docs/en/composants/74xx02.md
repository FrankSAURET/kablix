...
An Uno puts out 5 V: every family works. A **Pico only puts out 3.3 V**: only HC, AC, ACT and C work there — a 74LS02 on a Pico does nothing.
...
- NOR is universal: two cross-coupled NOR gates make an RS latch, the memory of one bit.
