...
DIL-14 package for the breadboard: **four independent NOR gates**, each with its two inputs and its output. A NOR gate outputs 1 **only when both inputs are 0**: an OR followed by an inverter.
...
only HC, AC, ACT and C work there — a 74LS02 on a Pico does nothing.

## Pins

| Pin | Name | Role |
|---|---|---|
| 1 | **Q1** | output of gate 1 |
| 2 | **A1** | input A of gate 1 |
| 3 | **B1** | input B of gate 1 |
| 4 | **Q2** | output of gate 2 |
| 5 | **A2** | input A of gate 2 |
| 6 | **B2** | input B of gate 2 |
| 7 | **GND** | ground — **black wire** |
| 8 | **B3** | input B of gate 3 |
| 9 | **A3** | input A of gate 3 |
| 10 | **Q3** | output of gate 3 |
| 11 | **B4** | input B of gate 4 |
...
|---|---|---|
| `ref` | Part number — changing it changes the pinout, not the drawing | 74xx02 |
...
- NOR is universal too: two cross-coupled NOR gates make an RS latch, the memory of one bit.
