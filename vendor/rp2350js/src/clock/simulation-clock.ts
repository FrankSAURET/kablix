...
export class SimulationClock implements IClock {
  ...
  linkAlarm(nanos: Float64, alarm: ClockAlarm) {
    ...
    // FIFO also matches the RP2350's round-robin DMA arbitration.
