...
const foreign = {
  ...
  parts: [
    ...
    { type: 'wokwi-ili9341', id: 'tft', left: 50, top: 50, attrs: {} },
  ],
  connections: [['tft:DATA', 'l:A', 'green', []]],
};
const r = fromWokwiDiagram(foreign);
check('composant connu importé, inconnu ignoré', r.parts.length === 1 && r.parts[0].id === 'l');
check('type inconnu signalé', r.skipped.includes('wokwi-ili9341'), JSON.stringify(r.skipped));
