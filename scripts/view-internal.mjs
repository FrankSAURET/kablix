...
const VARIANTS = {
  ...
  '4clk': { w: 200, h: 90, common:'cathode', digits:'4', colon:'true', pins: { A:{x:80,y:10},B:{x:120,y:10},F:{x:90,y:10},DIG1:{x:70,y:10},DIG2:{x:100,y:10},DIG3:{x:110,y:10},C:{x:100,y:80},D:{x:80,y:80},E:{x:70,y:80},G:{x:110,y:80},DP:{x:90,y:80},DIG4:{x:120,y:80} } },
  '4clka': { w: 200, h: 90, common:'anode', digits:'4', colon:'true', pins: { A:{x:80,y:10},B:{x:120,y:10},F:{x:90,y:10},DIG1:{x:70,y:10},DIG2:{x:100,y:10},DIG3:{x:110,y:10},C:{x:100,y:80},D:{x:80,y:80},E:{x:70,y:80},G:{x:110,y:80},DP:{x:90,y:80},DIG4:{x:120,y:80} } },
};
...
for (const [dig, v] of Object.entries(VARIANTS)) {
  ...
  const inner = internalWiringSvg('7segment', pins, { common: v.common, digits: v.digits ?? dig, ...(v.colon ? { colon: v.colon } : {}) }, undefined, { w, h }) || '';
